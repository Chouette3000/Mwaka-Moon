...
class Level4 extends Level{
	...
	initLevel(){
		...
		while(pos.y < (this.positionFinLvl.y-ecartY)){
			...
			pos2 = new BABYLON.Vector3(pos2.x+ecartXZ, pos.y, pos.z + ecartXZ);
			pos3 = new BABYLON.Vector3(pos.x + ecartXZ, pos.y, pos.z);this.plateforms.push(new Plateforme(this.scene, this.plateSize, new BABYLON.Vector3(pos2.x, pos2.y, pos2.z), "normal", this.spherePivot));
