var controlOn = false;
class BallControl {
    constructor( ball, playerCamera, levelControl = 3 ){
        this.ball = ball;
    ...
    speedMax(){
        return this.levelControl === 1 ? 80
            : this.levelControl === 2 ? 150
            : 300;
    }
    speedMin(){
        return this.levelControl === 1 ? 50
            : this.levelControl === 2 ? 80
            : 150;
    }
    listenerPosition(){
        ...
        window.addEventListener("keydown", function(evt) {
          if(controlOn){
            ...
            if(evt.keyCode === 38){ //key up
                ...
                this.speed = Math.max(this.speedMin() , Math.min(this.speedMax(), this.speed)) 
                this.speed*=1.1;
                this.turnBall()
            }
          }
